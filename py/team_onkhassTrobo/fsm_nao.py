...
def doStop():
    print("Je me mets en PLS")  # do some work
    sleep(deltat)
    newKey,val = getKey() # check if key pressed
...
def doRight():
    print("Let s turn right")  # do some work
    sleep(deltat)
    newKey,val = getKey() # check if key pressed
    event="Wait" # define the default event
    if newKey:
...
def doLeft():
    print("Let s turn left")  # do some work
    sleep(deltat)
    newKey,val = getKey() # check if key pressed
    event="Wait" # define the default event
    if newKey:
